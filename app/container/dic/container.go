...
// SafeGetLoanController works like SafeGet but only for LoanController.
// It does not return an interface but a controllers.LoanController.
func (c *Container) SafeGetLoanController() (controllers.LoanController, error) {
	i, err := c.ctn.SafeGet("loan-controller")
	if err != nil {
		var eo controllers.LoanController
		return eo, err
	}
	o, ok := i.(controllers.LoanController)
	if !ok {
		return o, errors.New("could get 'loan-controller' because the object could not be cast to controllers.LoanController")
	}
	return o, nil
}

// GetLoanController is similar to SafeGetLoanController but it does not return the error.
// Instead it panics.
func (c *Container) GetLoanController() controllers.LoanController {
	o, err := c.SafeGetLoanController()
	if err != nil {
		panic(err)
	}
	return o
...
// UnscopedSafeGetLoanController works like UnscopedSafeGet but only for LoanController.
// It does not return an interface but a controllers.LoanController.
func (c *Container) UnscopedSafeGetLoanController() (controllers.LoanController, error) {
	i, err := c.ctn.UnscopedSafeGet("loan-controller")
	if err != nil {
		var eo controllers.LoanController
		return eo, err
	}
...
// UnscopedGetLoanController is similar to UnscopedSafeGetLoanController but it does not return the error.
// Instead it panics.
func (c *Container) UnscopedGetLoanController() controllers.LoanController {
	o, err := c.UnscopedSafeGetLoanController()
	if err != nil {
		panic(err)
	}
	return o
...
// LoanController is similar to GetLoanController.
// It tries to find the container with the C method and the given interface.
// If the container can be retrieved, it applies the GetLoanController method.
// If the container can not be retrieved, it panics.
func LoanController(i interface{}) controllers.LoanController {
	return C(i).GetLoanController()
}

// SafeGetLoanRepository works like SafeGet but only for LoanRepository.
// It does not return an interface but a repositories.ILoanRepository.
func (c *Container) SafeGetLoanRepository() (repositories.ILoanRepository, error) {
	i, err := c.ctn.SafeGet("loan-repository")
	if err != nil {
		var eo repositories.ILoanRepository
		return eo, err
	}
	o, ok := i.(repositories.ILoanRepository)
	if !ok {
		return o, errors.New("could get 'loan-repository' because the object could not be cast to repositories.ILoanRepository")
	}
	return o, nil
}

// GetLoanRepository is similar to SafeGetLoanRepository but it does not return the error.
// Instead it panics.
func (c *Container) GetLoanRepository() repositories.ILoanRepository {
	o, err := c.SafeGetLoanRepository()
	if err != nil {
		panic(err)
	}
	return o
...
// UnscopedSafeGetLoanRepository works like UnscopedSafeGet but only for LoanRepository.
// It does not return an interface but a repositories.ILoanRepository.
func (c *Container) UnscopedSafeGetLoanRepository() (repositories.ILoanRepository, error) {
	i, err := c.ctn.UnscopedSafeGet("loan-repository")
	if err != nil {
		var eo repositories.ILoanRepository
		return eo, err
	}
...
// UnscopedGetLoanRepository is similar to UnscopedSafeGetLoanRepository but it does not return the error.
// Instead it panics.
func (c *Container) UnscopedGetLoanRepository() repositories.ILoanRepository {
	o, err := c.UnscopedSafeGetLoanRepository()
	if err != nil {
		panic(err)
	}
	return o
...
// LoanRepository is similar to GetLoanRepository.
// It tries to find the container with the C method and the given interface.
// If the container can be retrieved, it applies the GetLoanRepository method.
// If the container can not be retrieved, it panics.
func LoanRepository(i interface{}) repositories.ILoanRepository {
	return C(i).GetLoanRepository()
}

// SafeGetLoanService works like SafeGet but only for LoanService.
// It does not return an interface but a services.ILoanService.
func (c *Container) SafeGetLoanService() (services.ILoanService, error) {
	i, err := c.ctn.SafeGet("loan-service")
	if err != nil {
		var eo services.ILoanService
		return eo, err
	}
	o, ok := i.(services.ILoanService)
	if !ok {
		return o, errors.New("could get 'loan-service' because the object could not be cast to services.ILoanService")
	}
	return o, nil
}

// GetLoanService is similar to SafeGetLoanService but it does not return the error.
// Instead it panics.
func (c *Container) GetLoanService() services.ILoanService {
	o, err := c.SafeGetLoanService()
	if err != nil {
		panic(err)
	}
	return o
...
// UnscopedSafeGetLoanService works like UnscopedSafeGet but only for LoanService.
// It does not return an interface but a services.ILoanService.
func (c *Container) UnscopedSafeGetLoanService() (services.ILoanService, error) {
	i, err := c.ctn.UnscopedSafeGet("loan-service")
	if err != nil {
		var eo services.ILoanService
		return eo, err
	}
...
// UnscopedGetLoanService is similar to UnscopedSafeGetLoanService but it does not return the error.
// Instead it panics.
func (c *Container) UnscopedGetLoanService() services.ILoanService {
	o, err := c.UnscopedSafeGetLoanService()
	if err != nil {
		panic(err)
	}
	return o
...
// LoanService is similar to GetLoanService.
// It tries to find the container with the C method and the given interface.
// If the container can be retrieved, it applies the GetLoanService method.
// If the container can not be retrieved, it panics.
func LoanService(i interface{}) services.ILoanService {
	return C(i).GetLoanService()
}

// SafeGetRepaymentRepository works like SafeGet but only for RepaymentRepository.
// It does not return an interface but a repositories.IRepaymentRepository.
func (c *Container) SafeGetRepaymentRepository() (repositories.IRepaymentRepository, error) {
	i, err := c.ctn.SafeGet("repayment-repository")
	if err != nil {
		var eo repositories.IRepaymentRepository
		return eo, err
	}
	o, ok := i.(repositories.IRepaymentRepository)
	if !ok {
		return o, errors.New("could get 'repayment-repository' because the object could not be cast to repositories.IRepaymentRepository")
	}
	return o, nil
}

// GetRepaymentRepository is similar to SafeGetRepaymentRepository but it does not return the error.
// Instead it panics.
func (c *Container) GetRepaymentRepository() repositories.IRepaymentRepository {
	o, err := c.SafeGetRepaymentRepository()
	if err != nil {
		panic(err)
	}
	return o
...
// UnscopedSafeGetRepaymentRepository works like UnscopedSafeGet but only for RepaymentRepository.
// It does not return an interface but a repositories.IRepaymentRepository.
func (c *Container) UnscopedSafeGetRepaymentRepository() (repositories.IRepaymentRepository, error) {
	i, err := c.ctn.UnscopedSafeGet("repayment-repository")
	if err != nil {
		var eo repositories.IRepaymentRepository
		return eo, err
	}
...
// UnscopedGetRepaymentRepository is similar to UnscopedSafeGetRepaymentRepository but it does not return the error.
// Instead it panics.
func (c *Container) UnscopedGetRepaymentRepository() repositories.IRepaymentRepository {
	o, err := c.UnscopedSafeGetRepaymentRepository()
	if err != nil {
		panic(err)
	}
	return o
...
// RepaymentRepository is similar to GetRepaymentRepository.
// It tries to find the container with the C method and the given interface.
// If the container can be retrieved, it applies the GetRepaymentRepository method.
// If the container can not be retrieved, it panics.
func RepaymentRepository(i interface{}) repositories.IRepaymentRepository {
	return C(i).GetRepaymentRepository()
}
