...
func getDiDefs(provider dingo.Provider) []di.Def {
	return []di.Def{
		...
		},
		{
			...
			Scope: "app",
			Build: func(ctn di.Container) (interface{}, error) {
				d, err := provider.Get("loan-controller")
				if err != nil {
				...
				pi1, err := ctn.SafeGet("loan-service")
				if err != nil {
					var eo controllers.LoanController
					return eo, err
				}
				p1, ok := pi1.(services.ILoanService)
				if !ok {
					var eo controllers.LoanController
					return eo, errors.New("could not cast parameter 1 to services.ILoanService")
				}
				pi2, err := ctn.SafeGet("user-policy")
				if err != nil {
					var eo controllers.LoanController
					return eo, err
				}
				p2, ok := pi2.(policies.IUserPolicy)
				if !ok {
					var eo controllers.LoanController
					return eo, errors.New("could not cast parameter 2 to policies.IUserPolicy")
				}
				b, ok := d.Build.(func(services.IUserService, services.ILoanService, policies.IUserPolicy) (controllers.LoanController, error))
				if !ok {
					var eo controllers.LoanController
					return eo, errors.New("could not cast build function to func(services.IUserService, services.ILoanService, policies.IUserPolicy) (controllers.LoanController, error)")
				}
				return b(p0, p1, p2)
			},
			Close: func(obj interface{}) error {
		...
		},
		{
			...
			Scope: "app",
			Build: func(ctn di.Container) (interface{}, error) {
				d, err := provider.Get("loan-repository")
				if err != nil {
				...
				b, ok := d.Build.(func(infrastructures.IGormDatabase) (repositories.ILoanRepository, error))
				if !ok {
					var eo repositories.ILoanRepository
					return eo, errors.New("could not cast build function to func(infrastructures.IGormDatabase) (repositories.ILoanRepository, error)")
				}
				return b(p0)
			},
			Close: func(obj interface{}) error {
		...
		},
		{
			...
			Scope: "app",
			Build: func(ctn di.Container) (interface{}, error) {
				d, err := provider.Get("loan-service")
				if err != nil {
					var eo services.ILoanService
					return eo, err
				}
				pi0, err := ctn.SafeGet("loan-repository")
				if err != nil {
					var eo services.ILoanService
					return eo, err
				}
				p0, ok := pi0.(repositories.ILoanRepository)
				if !ok {
					var eo services.ILoanService
					return eo, errors.New("could not cast parameter 0 to repositories.ILoanRepository")
				}
				pi1, err := ctn.SafeGet("repayment-repository")
				if err != nil {
					var eo services.ILoanService
					return eo, err
				}
				p1, ok := pi1.(repositories.IRepaymentRepository)
				if !ok {
					var eo services.ILoanService
					return eo, errors.New("could not cast parameter 1 to repositories.IRepaymentRepository")
				}
				b, ok := d.Build.(func(repositories.ILoanRepository, repositories.IRepaymentRepository) (services.ILoanService, error))
				if !ok {
					var eo services.ILoanService
					return eo, errors.New("could not cast build function to func(repositories.ILoanRepository, repositories.IRepaymentRepository) (services.ILoanService, error)")
				}
				return b(p0, p1)
			},
			Close: func(obj interface{}) error {
		...
		},
		{
			...
			Scope: "app",
			Build: func(ctn di.Container) (interface{}, error) {
				d, err := provider.Get("repayment-repository")
				if err != nil {
				...
				b, ok := d.Build.(func(infrastructures.IGormDatabase) (repositories.IRepaymentRepository, error))
				if !ok {
					var eo repositories.IRepaymentRepository
					return eo, errors.New("could not cast build function to func(infrastructures.IGormDatabase) (repositories.IRepaymentRepository, error)")
				}
				return b(p0)
			},
			Close: func(obj interface{}) error {
