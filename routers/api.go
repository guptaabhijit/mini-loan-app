...
func Route(e *echo.Echo) {
	...
	r.GET("/users/:user", app.Application.Container.GetUserController().Show, GMiddleware.Or(app.Application.Container.GetIsAdminMiddleware()))
	r.GET("/users", app.Application.Container.GetUserController().Index)

	r.POST("/loan", app.Application.Container.GetLoanController().CreateLoan)
	r.GET("/loan", app.Application.Container.GetLoanController().FetchLoan)
	r.POST("/loan/approve/:loan", app.Application.Container.GetLoanController().ApproveLoan, GMiddleware.Or(app.Application.Container.GetIsAdminMiddleware()))

	r.POST("/loan/repay/:loan", app.Application.Container.GetLoanController().RepayLoan)
